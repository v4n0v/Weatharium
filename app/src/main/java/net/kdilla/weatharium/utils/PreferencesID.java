...
public class PreferencesID {
    ...
    public static final String SAVED_ADD_WIND = "saved_wind";
    public static final String SAVED_ADD_PRESSURE = "saved_pressure";
    public static final String SAVED_ADD_STORM = "saved_storm";
